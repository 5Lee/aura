...
const ADMIN_NAV_ITEMS = [
  ...
  { href: "/admin/governance", label: "治理" },
  { href: "/admin/interoperability", label: "互通" },
  { href: "/admin/ops-center", label: "任务" },
  { href: "/admin/notification-orchestration", label: "通知" },
  { href: "/admin/ops-analytics", label: "漏斗" },
  { href: "/admin/playbook-market", label: "Playbook" },
  { href: "/admin/reliability-gates", label: "闸门" },
  { href: "/admin/self-heal", label: "自愈" },
  { href: "/admin/release-orchestration", label: "发布" },
  { href: "/admin/phase6-closure", label: "终验" },
