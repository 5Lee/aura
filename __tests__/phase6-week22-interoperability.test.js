...
test("interop dashboard exposes mapping, preview and compatibility workflow", () => {
  ...
  assert.match(interopPanelSource, /buildProfileForm/)
  assert.match(interopPanelSource, /const selectedProfile = useMemo/)
  assert.match(interopPanelSource, /setProfileForm\(buildProfileForm\(selectedProfile\)\)/)
