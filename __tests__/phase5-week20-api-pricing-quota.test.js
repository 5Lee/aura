...
test("developer api routes support api key lifecycle, metering, overage and abuse protection", () => {
  ...
  assert.match(consumeRouteSource, /resolveBlockedReasonErrorMessage/)
  assert.match(consumeRouteSource, /rate-limit-exceeded/)
  assert.match(consumeRouteSource, /error: resolveBlockedReasonErrorMessage/)
